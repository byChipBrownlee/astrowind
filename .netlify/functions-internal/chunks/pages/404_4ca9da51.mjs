...
import { e as createAstro, f as createComponent, A as AstroError, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as defineScriptVars, j as renderComponent, u as unescapeHTML, F as Fragment, k as renderHead, l as renderSlot } from '../astro_9c060e94.mjs';
...
import { i as isESMImportedImage, g as getImage$1 } from '../astro/assets-service_af326c89.mjs';
...
const favIconSvg = new Proxy({"src":"/_astro/favicon.2d7a3102.svg","width":128,"height":128,"format":"svg"}, {
...
const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.1de27c4e.png","width":180,"height":180,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/app-store.png": () => import('./mobile-app_0cdd7564.mjs').then(n => n.a),"/src/assets/images/default.png": () => import('../default_7e10ea97.mjs'),"/src/assets/images/google-play.png": () => import('./mobile-app_0cdd7564.mjs').then(n => n.g),"/src/assets/images/hero.png": () => import('../hero_d34881fd.mjs')});
  } catch (e) {
  }
  return images;
};

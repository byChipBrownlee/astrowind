import { e as createAstro, f as createComponent, r as renderTemplate, j as renderComponent, m as maybeRenderHead, F as Fragment, u as unescapeHTML } from '../astro_9c060e94.mjs';
import 'clsx';
import { $ as $$WidgetWrapper, a as $$Headline, e as $$Image, b as $$Button, l as $$Features3, k as $$Stats, c as $$Header, d as $$PageLayout } from './about_87c99c40.mjs';
import { b as $$Hero2, $ as $$CallToAction } from './click-through_21a255be.mjs';
import { $ as $$Content, a as $$FAQs } from './index_a9f9f6e6.mjs';
...
}, "/Users/charlesbrownlee/Documents/GitHub/byChipBrownlee/exploration/astrowind/src/components/widgets/Testimonials.astro", void 0);

const appStoreImg = new Proxy({"src":"/_astro/app-store.4cd7a2ff.png","width":300,"height":89,"format":"png"}, {
...
const googlePlayImg = new Proxy({"src":"/_astro/google-play.2a9ea62e.png","width":300,"height":89,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
}, "/Users/charlesbrownlee/Documents/GitHub/byChipBrownlee/exploration/astrowind/src/pages/homes/mobile-app.astro", void 0);

const $$file = "/Users/charlesbrownlee/Documents/GitHub/byChipBrownlee/exploration/astrowind/src/pages/homes/mobile-app.astro";

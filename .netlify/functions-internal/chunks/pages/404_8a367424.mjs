...
const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/app-store.png": () => import('./mobile-app_8a71c1f2.mjs').then(n => n.a),"/src/assets/images/default.png": () => import('../default_7e10ea97.mjs'),"/src/assets/images/google-play.png": () => import('./mobile-app_8a71c1f2.mjs').then(n => n.g),"/src/assets/images/hero.png": () => import('../hero_d34881fd.mjs')});
  } catch (e) {
  }
  return images;
};
